...
class CreateTripTerminationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trip_terminations', function (Blueprint $table) {
            ...
            $table->integer('number_of_trip_terminate_attempt')->nullable();
            $table->integer('succeded_trip_terminate_attempt')->nullable();
            $table->integer('trip_terminated')->default('0');
    ...
    {
        Schema::dropIfExists('trip_terminations');
    }
}
