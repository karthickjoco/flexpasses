...
<div style="margin-top:10px;">
    ...
    <p style="margin: 5px">&nbsp;Here are the trips taken on {{\Carbon\Carbon::now()->subtract('1 day')->format('m/d/Y')}} </p>
    ...
    <div style=" margin:10px;
        font-size:14px;">
        <p style="margin: 2px;font-weight: bold;">Totals Trip Qty: {{count($details)}}</p>
